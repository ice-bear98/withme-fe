...
export default function MyManage() {
  ...
  return (
    <div className="p-4 max-w-4xl m-auto">
      <div className="h-10 leading-10 mb-5 text-xl font-['LINESeedKR-Bd'] flex items-center justify-center dark:text-gray-200">
        ...
        <div className="flex-col gap-4 bg-white pt-4 rounded-2xl border shadow-lg overflow-hidden dark:bg-gray-500 dark:border-none">
          ...
          <div className="flex w-auto h-64">
            ...
            <div className="ml-2 s:text-xs w-full">
              <h2 className="py-2 rounded-3xl mb-4 dark:text-gray-100">안녕하세요 요리 모임을 하고있습니다.</h2>
              ...
              <p className="bg-white p-1 rounded-lg dark:bg-inherit dark:text-gray-200">작성자 : 홍길동</p>
              <p className="bg-white p-1 rounded-lg dark:bg-inherit dark:text-gray-200">현재 모집중 ( 2 / 8 )</p>
            </div>
          </div>
          <button
            onClick={() => setOpen(true)}
            className="mt-2 bg-brand_2 border-t-2 border-bg_blue-300  w-full text-center p-2 text-white dark:border-none dark:text-black"
          >
            신청 현황 보기
          </button>
